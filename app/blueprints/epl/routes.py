...
def api_get_standings():
    ...
    result = get_cached_data("epl_standings", fetch_standings, expiry_seconds=60)
...
def api_get_schedule():
    ...
    cache_key = f"epl_schedule_{date_param}_{limit}"
...
def api_get_arsenal_schedule():
    ...
    result = get_cached_data("epl_arsenal_schedule", fetch_arsenal_schedule, expiry_seconds=60)
    return jsonify(result)
